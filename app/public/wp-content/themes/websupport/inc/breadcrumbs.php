 ...
 * simple php function call in the theme page, i.e. <?php breadcrumbs(); ?>
 */
...
function breadcrumbs() {
	...
	if ( !is_front_page() ) {
		...
		if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
		...
		} elseif ( is_singular( array( 'course' ) ) ) {

			echo '<li><a href="' . get_the_permalink( get_page_by_title( 'courses' ) ) . '" title="' .
			     get_the_title( get_page_by_title( 'courses'	) ) . '">' . get_the_title( get_page_by_title( 'courses'	) ) . '</a></li>';
			...
			/*echo '<li><a href="' . get_the_permalink( get_option( 'page_for_posts' ) ) . '" title="' . get_bloginfo('name') . ' ' . get_the_title(
					get_option( 'page_for_posts' ) ) . '">' . get_the_title(
				     get_option( 'page_for_posts' ) ) . '</a></li>';*/
